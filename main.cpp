...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	// 書き込むためのアドレスを取得
	wvpResourceSphere->Map(0, nullptr, reinterpret_cast<void**>(&transformationMatrixDataSphere));
	...
	// TransfromSphereの設定
	Transform transformSphere{ {1.0f, 1.0f, 1.0f},{0.0f, 0.0f, 0.0f},{10.0f, 0.0f, 0.0f} };
	...
	while (msg.message != WM_QUIT) {
		...
		if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
			...
			switch (currentScene) {
			case Scene::Sprite:
				ImGui::Text("Scene: Sprite");
				ImGui::Checkbox("useMonsterBall", &useMonsterBall);
				ImGui::SliderFloat3("Translate", &transformSprite.translate.x, -10.0f, 10.0f);
			...
			case Scene::obj:
				ImGui::Text("Scene: Obj");
				ImGui::SliderFloat("Obj Rotate Y", &transform.rotate.y, -3.14f, 3.14f);
				// ここに obj 固有の設定があれば追加
				break;

			case Scene::sphere:
				ImGui::Text("Scene: Sphere");
